...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthGuard.Core.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("HealthGuard.Core.Entities.Notification", b =>
                {
                    b.HasOne("HealthGuard.Core.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HealthGuard.Core.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
